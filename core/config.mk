...
ifneq ($(APOLLO_BUILD),)
include vendor/apollo/config/BoardConfigApollo.mk
endif
...
ifneq ($(APOLLO_BUILD),)
ifneq ($(wildcard device/apollo/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/apollo/sepolicy/common/sepolicy.mk)
endif
endif
